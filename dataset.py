...
def main(dexycb_dir: str):
    ...
    # 添加调试：打印数据集基本信息
    print(f"数据集路径: {dexycb_dir}")
    print(f"捕获数据总数: {len(dataset._captures)}")
    ...
    for i, data in enumerate(dataset):
        ...
        for id in ycb_ids:
            ycb_names.append(YCB_CLASSES[id])        
...
if __name__ == "__main__":
    # main(dexycb_dir = r"D:\Code\DATASET\DexYCB")
    main(dexycb_dir = r"D:\study\SRTP_hand\subDexYCB")
